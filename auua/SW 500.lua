...
SWEP.Primary.KickUp				= 22.6		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 18.5		-- Maximum down recoil (skeet)
...
SWEP.Primary.IronAccuracy = .0215 -- Ironsight accuracy, should be the same for shotguns
