...
SWEP.Gun = ("m9k_m16a2") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/v_cstm_m16a4.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_m16.mdl"	-- Weapon world model
...
SWEP.Primary.KickUp				= 2.9		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 1.8	-- Maximum down recoil (skeet)
...
SWEP.IronSightsPos = Vector (2.037, -3.8941, 0.8809)
SWEP.IronSightsAng = Vector (0, 0, 0)
SWEP.SightsPos = Vector (-2.18, 0, 0.3)
