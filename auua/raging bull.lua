...
SWEP.Primary.KickUp				= 19.2		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 12.4		-- Maximum down recoil (skeet)
...
SWEP.Primary.Spread		= .044	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .0224 -- Ironsight accuracy, should be the same for shotguns

-- Enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(2.773, 0, 0.846)
SWEP.IronSightsAng = Vector(-0.157, 0, 0)
SWEP.SightsPos = Vector(2.773, 0, 0.828)
