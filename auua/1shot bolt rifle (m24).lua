...
SWEP.Primary.RPM				= 14		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 5		-- Size of a clip
SWEP.Primary.DefaultClip			= 0	-- Bullets you start with
SWEP.Primary.KickUp				= 17.6				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 14.6			-- Maximum down recoil (skeet)
...
SWEP.Primary.IronAccuracy = .00055 -- ironsight accuracy, should be the same for shotguns
