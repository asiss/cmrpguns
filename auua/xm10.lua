...
SWEP.Gun = ("m9k_xm1014") -- must be the name of your swep but NO CAPITALS!
...
SWEP.SlotPos				= 88			-- Position in the slot
...
SWEP.Primary.KickUp				= 14				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 10.2		-- Maximum down recoil (skeet)
...
SWEP.Primary.Spread		= .064	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .064	-- Ironsight accuracy, should be the same for shotguns
