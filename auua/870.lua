...
SWEP.SlotPos				= 87			-- Position in the slot
...
SWEP.Primary.KickDown			= 7.8		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 4.8	-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= .062	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .062	-- Ironsight accuracy, should be the same for shotguns
