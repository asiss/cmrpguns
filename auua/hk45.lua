...
SWEP.Primary.KickUp				= 4.8		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 2.1		-- Maximum down recoil (skeet)
...
SWEP.Primary.Spread		= .040	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
