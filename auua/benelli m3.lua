...
SWEP.Primary.KickUp				= 8.8			-- Maximum up recoil (rise)
...
SWEP.Primary.Spread		= .054	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .054	-- Ironsight accuracy, should be the same for shotguns
