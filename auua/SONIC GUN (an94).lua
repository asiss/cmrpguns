...
SWEP.ViewModel				= "models/weapons/v_rif_an94k.mdl"	-- Weapon view model
...
SWEP.Primary.RPM			= 670			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 30		-- Size of a clip
SWEP.Primary.DefaultClip		= 0		-- Bullets you start with
SWEP.Primary.KickUp				= 2.75		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 2.2	-- Maximum down recoil (skeet)
...
SWEP.Primary.IronAccuracy = .0188 -- Ironsight accuracy, should be the same for shotguns

-- Enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(0, 0, 0)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-3.95, 0, 1.9)
