...
SWEP.PrintName				= "PKM Machine Gun"		-- Weapon name (Shown on HUD)	
SWEP.Slot				= 2				-- Slot in the weapon selection menu
SWEP.SlotPos				= 92			-- Position in the slot
...
SWEP.Primary.RPM			= 440			-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-2.215, -2.116, 0.23)
