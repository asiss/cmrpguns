...
SWEP.Gun = ("m9k_rpk") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/v_mach_4249para.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_ak74.mdl"	-- Weapon world model
...
SWEP.Primary.DefaultClip		= 2400		-- Bullets you start with
SWEP.Primary.KickUp				= 1.4		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 1.1		-- Maximum down recoil (skeet)
...
SWEP.SightsPos = Vector(-1.865, 0, 0.87)
