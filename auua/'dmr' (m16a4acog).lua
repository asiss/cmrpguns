...
SWEP.PrintName				= "M16A4 DMR"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM				= 220		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 30		-- Size of a clip
SWEP.Primary.DefaultClip			= 0	-- Bullets you start with
SWEP.Primary.KickUp				= 3.2		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 2.4	-- Maximum down recoil (skeet)
