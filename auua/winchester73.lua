...
SWEP.Primary.KickUp			= 20.5				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 15.1		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal			= 6.8	-- Maximum up recoil (stock)
...
SWEP.Primary.IronAccuracy = .021	-- Ironsight accuracy, should be the same for shotguns
