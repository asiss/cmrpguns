...
SWEP.Primary.DefaultClip		= 158	-- Default number of bullets in a clip
SWEP.Primary.KickUp				= 14.1				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 9.2		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 6.3	-- Maximum up recoil (stock)
...
SWEP.SightsPos = Vector(2.657, .394, 1.7)
