...
SWEP.PrintName				= "M249 Light Machine Gun"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Damage		= 3.5	-- Base damage per bullet
SWEP.Primary.Spread		= .0495	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
