...
SWEP.Primary.KickUp				= 2.7		-- Maximum up recoil (rise)
...
SWEP.Primary.Spread		= .0288	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .0146 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.SightsPos = Vector(-2.66, 0.187, 0.33)
