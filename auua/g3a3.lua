...
SWEP.ViewModel				= "models/weapons/krycek/v_hk_g3_m9k.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/krycek/w_hk_g3.mdl"	-- Weapon world model
SWEP.ShowWorldModel			= true
SWEP.Base				= "kryceks_custom_swep_base_m9k"
SWEP.Spawnable				= true
...
SWEP.Primary.KickDown			= 3.4	-- Maximum down recoil (skeet)
...
SWEP.SightsPos = Vector(-2.54, -2.069, 0.66)
SWEP.SightsAng = Vector(-0.109, 15, 0)
