...
SWEP.Gun = ("m9k_repeater") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "SAR2 Folsom Repeater"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_eq_gun1.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_eqgun.mdl"	-- Weapon world model
SWEP.Base				= "bobs_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("weapons/ar1/ar1_dist1.wav")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector (2, -1.8353, 1)
